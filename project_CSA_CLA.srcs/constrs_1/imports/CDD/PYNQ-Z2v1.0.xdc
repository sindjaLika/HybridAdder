...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { oRX_A }]; 
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { oRX_B  }]; 
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { oADDER }]; 
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { oLED_TX }]; 
...
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports iRx]
...
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports oTx]
